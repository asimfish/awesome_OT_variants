...
| [`INDEX.md`](INDEX.md) | 文档地图与 12 篇精读论文一览；每篇在 `<arxiv_id>_<slug>/` 下有 `metadata.json` 与中文 `report.md` |
...
- [0. 证据等级与会议覆盖口径](#0-证据等级与会议覆盖口径)
  - [0.1 状态标签](#01-状态标签)
  - [0.2 用户指定会议的时间覆盖](#02-用户指定会议的时间覆盖)
- [1. 先建立 OT 研究地图](#1-先建立-ot-研究地图)
- [2. 基础教材、讲义和综述](#2-基础教材讲义和综述)
  - [2.1 主教材](#21-主教材)
  - [2.2 经典论文链：按问题而不是按年代读](#22-经典论文链按问题而不是按年代读)
- [3. 2024–2026 正式会议论文目录](#3-20242026-正式会议论文目录)
  - [3.1 NeurIPS](#31-neurips)
  - [3.2 ICML](#32-icml)
  - [3.3 ICLR](#33-iclr)
  - [3.4 CVPR](#34-cvpr)
  - [3.5 ICCV 2025 — \[P\]](#35-iccv-2025--p)
  - [3.6 ECCV 2024 — \[P\]](#36-eccv-2024--p)
  - [3.7 AAAI](#37-aaai)
- [4. 2025–2026 前沿预印本：不要与会议论文混写](#4-20252026-前沿预印本不要与会议论文混写)
- [5. 优质课程、教程与博客](#5-优质课程教程与博客)
  - [5.1 系统课程](#51-系统课程)
  - [5.2 视频与短教程](#52-视频与短教程)
  - [5.3 直觉型网页与博客](#53-直觉型网页与博客)
- [6. 软件与复现实验栈](#6-软件与复现实验栈)
  - [6.1 建议的统一 benchmark 记录](#61-建议的统一-benchmark-记录)
- [7. 五条可执行阅读路线](#7-五条可执行阅读路线)
  - [路线 A：FlashSinkhorn 与大规模 Sinkhorn（4–6 周）](#路线-aflashsinkhorn-与大规模-sinkhorn46-周)
  - [路线 B：黎曼流形 OT（6–8 周）](#路线-b黎曼流形-ot68-周)
  - [路线 C：Wasserstein barycenter（6–8 周）](#路线-cwasserstein-barycenter68-周)
  - [路线 D：MMOT 与 Schrödinger bridge（8–10 周）](#路线-dmmot-与-schrödinger-bridge810-周)
  - [路线 E：GW 与跨空间对齐（5–7 周）](#路线-egw-与跨空间对齐57-周)
- [8. 建议的本地文献管理字段](#8-建议的本地文献管理字段)
  - [8.1 每月更新程序](#81-每月更新程序)
- [9. 先读哪 15 篇](#9-先读哪-15-篇)
